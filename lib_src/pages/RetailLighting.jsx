...
const retailImg = "/images/Smarvy Spot/150.webp"; 
...
const schema = {
  ...
  "@graph": [
    {
      "@type": "Service",
      "serviceType": "Luxury Retail Lighting Solutions",
      "provider": {
        "@type": "Organization",
      ...
      "description": "Bespoke retail lighting design, supply, and installation across Dubai and the GCC."
    },
    {
      "@type": "BreadcrumbList",
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Retail Lighting" }
      ]
    }
  ]
};
